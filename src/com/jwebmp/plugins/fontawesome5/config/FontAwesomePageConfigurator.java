	...
	public Page configure(Page page) {
		...
		if (!page.isConfigured()) {
			...
			case WebFontCSS: {
				...
				if(includeAll)
				{
					page.addCssReference(new CSSReference("FontAwesome5CSSWebFontsAll",5.013 ,rootReferenceDir + 
						"web-fonts-with-css/css/fontawesome-all.min.css" ));
				}
				else {
					if(includeBrands)
					{
						page.addCssReference(new CSSReference("FontAwesome5CSSWebFontsBrands",5.013 ,rootReferenceDir +
							"web-fonts-with-css/css/fa-brands.min.css" ));
					}
					if(includeLight)
					{
						page.addCssReference(new CSSReference("FontAwesome5CSSWebFontsLight",5.013 ,rootReferenceDir +
							"web-fonts-with-css/css/fa-light.min.css" ));
					}
					if(includeRegular)
					{
						page.addCssReference(new CSSReference("FontAwesome5CSSWebFontsRegular",5.013 ,rootReferenceDir +
							"web-fonts-with-css/css/fa-regular.min.css" ));
					}
					if(includeSolid)
					{
						page.addCssReference(new CSSReference("FontAwesome5CSSWebFontsSolid",5.013 ,rootReferenceDir +
							"web-fonts-with-css/css/fa-solid.min.css" ));
					}
				}
			...
			case JS: {
				if (!configOptions.toString(true).replace("\\{", "").replace("\\}", "").trim().isEmpty())
				{
					page.addJavaScriptReference(new JavascriptReference("FontAwesome5Configuration", 1.0, FontAwesome5Binder
						.getFontAwesome5SiteBinding().replace("/", "")).setSortOrder(5));
				}
				
				if(includeAll) {
					page.addJavaScriptReference(new JavascriptReference("FontAwesome5All", 5.013, rootReferenceDir + 
						"svg-with-js/js/fontawesome-all.min.js").setSortOrder(6));
				}
				else
				{
					page.addJavaScriptReference(new JavascriptReference("FontAwesome5Core", 5.013, rootReferenceDir +
						"svg-with-js/js/fontawesome.min.js").setSortOrder(8));
					if(includeRegular)
					{
						page.addJavaScriptReference(new JavascriptReference("FontAwesome5Regular", 5.013, rootReferenceDir +
							"svg-with-js/js/fa-regular.min.js").setSortOrder(7));
					}
					if(includeSolid)
					{
						page.addJavaScriptReference(new JavascriptReference("FontAwesome5Solid", 5.013, rootReferenceDir +
							"svg-with-js/js/fa-solid.min.js").setSortOrder(7));
					}
					if(includeLight)
					{
						page.addJavaScriptReference(new JavascriptReference("FontAwesome5Light", 5.013, rootReferenceDir +
							"svg-with-js/js/fa-light.min.js").setSortOrder(7));
					}
					if(includeBrands)
					{
						page.addJavaScriptReference(new JavascriptReference("FontAwesome5Brands", 5.013, rootReferenceDir +
							"svg-with-js/js/fa-brands.min.js").setSortOrder(7));
					}
				}
